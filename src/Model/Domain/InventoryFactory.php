...
class InventoryFactory implements DomainGSheetObjectFactoryInterface
{
    ...
    public function createGSuiteHandlingSpecifications(): GSuiteHandlingSpecificationsInterface
    {
        return new GSuiteHandlingSpecifications($this->targettedHeadingValues);
    }
